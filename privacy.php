...
<body>
    ...
    <div id="container">
        <header>
            <div></div>
            <h1>Privacy Policy of swiiika.com</h1>
            <div></div>
        </header>

        <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure
            of Personal Information if anyone decided to use our Service, the Swiiika website.</p>
        ...
        <p>Our Privacy Policy was created with the help of the <a href="https://www.privacypolicytemplate.net">Privacy
                Policy Template</a>.</p>
