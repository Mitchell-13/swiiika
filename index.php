        ...
        <div id="pricing-content">
            ...
            <table id="pricing-table">
                ...
                <tr>
                    ...
                    <td>
                        <ul>
                            <li>I'll search VODs & clips on your channel to find content that would perform well on short-from social sites</li>
                            <li>I'll schedule, manage & post edited content on your socials with proper titles and tags</li>
                    ...
                    <td>
                        <ul>
                            ...
                            <ul>
                                ...
                                <li>Proper Scaling & Cropping for vertical platforms (Tiktok, Youtube Shorts, Reels, etc.)</li>
                            </ul>
                        </ul>
                    </td>
                    <td>$50 <span class="sub-text">(subtitles)</span> <br>$45<span class="sub-text">(no subtitles)</span></td>
                </tr>
            </table>
        </div>
    </div>
